...
class Random {
  ...
  Random(
    ...
    if (Capacity != "infinity") SysCapacity = Capacity;
    SystemType = getSystemType();
    trafficIntensity =
        (arrivalRateAvarage / serviceRateAvarage) / parallelServers;
    double.parse(trafficIntensity.toStringAsFixed(4)) == 1
        ? trafficIntensity = 1
        : trafficIntensity = trafficIntensity;
  }
  String getSystemType() {
    if (parallelServers == 1 && (Capacity == "infinity"))
      return "M/M/1/∞/FCFS";
    else if (parallelServers == 1 && (Capacity != "infinity"))
      return "M/M/1/K/FCFS";
    else if (parallelServers != 1 && (Capacity == "infinity"))
      return "M/M/C/∞/FCFS";
    else
